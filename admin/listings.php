...
<section class="listings">
    ...
    <div class="box-container">
        ...
        if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
            ...
            $select_listings = $conn->prepare("SELECT * FROM `property` WHERE property_name LIKE '%{$search_box}%' 
                            OR address LIKE '%{$search_box}%' ORDER BY date DESC");
        ...
        if($select_listings->rowCount() > 0){
            while($fetch_listing = $select_listings->fetch(PDO::FETCH_ASSOC)){
                ...
                <div class="box">
                    ...
                    <p class="price"><i class="fas fa-coin"></i><?= $fetch_listing['price']; ?></p>
